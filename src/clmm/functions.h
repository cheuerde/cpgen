...
class function_fixed: public function_base {
	...
	public:
		...
		inline void initialize(base_methods_abstract*& base_fun,VectorXd& xtx, int& columns,
				       VectorXd& var, VectorXd& mean_var, double& var_y,
				       bool& initialized, int total_number_effects);
		inline void sample_effects(base_methods_abstract*& base_fun,VectorXd& xtx,
					   VectorXd& estimates, double * ycorr, VectorXd& var,
					   double * var_e, sampler& mcmc_sampler, mp_container& thread_vec);
		inline void sample_variance(VectorXd& var, double& scale, double& df, VectorXd& estimates,
					    int& columns, sampler& mcmc_sampler, vector<double>& var_posterior,int niter){};
...
template<class T>
void function_fixed<T>::initialize(base_methods_abstract*& base_fun,VectorXd& xtx, int& columns,
				   VectorXd& var, VectorXd& mean_var, double& var_y,
				   bool& initialized, int total_number_effects) {
...
template<class T>
void function_fixed<T>::sample_effects(base_methods_abstract*& base_fun,VectorXd& xtx,
				       VectorXd& estimates, double * ycorr, VectorXd& var,
				       double * var_e, sampler& mcmc_sampler, mp_container& thread_vec) {
...
template<class T>
void function_random<T>::initialize(base_methods_abstract*& base_fun,VectorXd& xtx, int& columns,
				    VectorXd& var, VectorXd& mean_var, double& var_y,
				    bool& initialized, int total_number_effects) {
...
template<class T>
void function_random<T>::sample_effects(base_methods_abstract*& base_fun,VectorXd& xtx,
					VectorXd& estimates, double * ycorr, VectorXd& var,
					double * var_e, sampler& mcmc_sampler, mp_container& thread_vec) {
...
template<class T>
void function_random<T>::sample_variance(VectorXd& var, double& scale, double& df, VectorXd& estimates,
					 int& columns, sampler& mcmc_sampler, vector<double>& var_posterior,int niter) {
...
template<class T>
void function_bayesA<T>::initialize(base_methods_abstract*& base_fun,VectorXd& xtx, int& columns,
				    VectorXd& var, VectorXd& mean_var, double& var_y,
				    bool& initialized, int total_number_effects) {
...
template<class T>
void function_bayesA<T>::sample_effects(base_methods_abstract*& base_fun,VectorXd& xtx,
					VectorXd& estimates, double * ycorr, VectorXd& var,
					double * var_e, sampler& mcmc_sampler, mp_container& thread_vec) {
...
template<class T>
void function_bayesA<T>::sample_variance(VectorXd& var, double& scale, double& df, VectorXd& estimates,
					 int& columns, sampler& mcmc_sampler, vector<double>& var_posterior,int niter) {
...
template<class T1, class T2>
void function_ridge_ginv<T1, T2>::initialize(base_methods_abstract*& base_fun,VectorXd& xtx, int& columns,
					     VectorXd& var, VectorXd& mean_var, double& var_y,
					     bool& initialized, int total_number_effects) {
...
template<class T1, class T2>
void function_ridge_ginv<T1, T2>::sample_effects(base_methods_abstract*& base_fun,VectorXd& xtx,
						 VectorXd& estimates, double * ycorr, VectorXd& var,
						 double * var_e, sampler& mcmc_sampler, mp_container& thread_vec) {
...
template<>
void function_ridge_ginv<MapSparseMatrixXd, MapSparseMatrixXd>::sample_effects(base_methods_abstract*& base_fun,VectorXd& xtx,
									       VectorXd& estimates, double * ycorr, VectorXd& var,
									       double * var_e, sampler& mcmc_sampler, mp_container& thread_vec) {
...
template<>
void function_ridge_ginv<MapSparseMatrixXd, MapMatrixXd>::sample_effects(base_methods_abstract*& base_fun,VectorXd& xtx,
									 VectorXd& estimates, double * ycorr, VectorXd& var,
									 double * var_e, sampler& mcmc_sampler, mp_container& thread_vec) {
...
// This is a specialization for the case of a
// dense design matrix and dense Ginverse (could happen).

template<>
void function_ridge_ginv<MapMatrixXd, MapMatrixXd>::sample_effects(base_methods_abstract*& base_fun,VectorXd& xtx,
									 VectorXd& estimates, double * ycorr, VectorXd& var,
									 double * var_e, sampler& mcmc_sampler, mp_container& thread_vec) {
...
template<class T1, class T2>
void function_ridge_ginv<T1, T2>::sample_variance(VectorXd& var, double& scale, double& df, VectorXd& estimates,
						  int& columns, sampler& mcmc_sampler, vector<double>& var_posterior,int niter) {
