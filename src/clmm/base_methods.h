...
class base_methods_st: public base_methods_abstract {
	...
	public:
		...
		inline void sample_effects(MapMatrixXd& Z, VectorXd& xtx, VectorXd& estimates, 
					   double * ycorr, VectorXd& var, double * var_e, 
					   sampler& mcmc_sampler,mp_container& thread_vec, double lambda = 1);
		inline void sample_effects(MapSparseMatrixXd& Z, VectorXd& xtx, VectorXd& estimates,
					   double * ycorr, VectorXd& var, double * var_e, 
					   sampler& mcmc_sampler,mp_container& thread_vec, double lambda = 1);
...
void base_methods_st::sample_effects(MapMatrixXd& Z, VectorXd& xtx, VectorXd& estimates, 
				     double * ycorr, VectorXd& var, double * var_e, 
				     sampler& mcmc_sampler, mp_container& thread_vec, double lambda) {
...
void base_methods_st::sample_effects(MapSparseMatrixXd& Z, VectorXd& xtx, VectorXd& estimates, 
				     double * ycorr, VectorXd& var, double * var_e, 
				     sampler& mcmc_sampler, mp_container& thread_vec, double lambda) {
...
void base_methods_mp::sample_effects(MapMatrixXd& Z, VectorXd& xtx, VectorXd& estimates, 
				     double * ycorr, VectorXd& var, double * var_e, 
				     sampler& mcmc_sampler, mp_container& thread_vec, double lambda) {
...
// sparse specialization
void base_methods_mp::sample_effects(MapSparseMatrixXd& Z, VectorXd& xtx, VectorXd& estimates, 
				     double * ycorr, VectorXd& var, double * var_e, 
				     sampler& mcmc_sampler, mp_container& thread_vec, double lambda) {
...
void base_methods_BLAS::sample_effects(MapMatrixXd& Z, VectorXd& xtx, VectorXd& estimates, 
				       double * ycorr, VectorXd& var, double * var_e, 
				       sampler& mcmc_sampler, mp_container& thread_vec, double lambda) {
...
// sparse specialization
void base_methods_BLAS::sample_effects(MapSparseMatrixXd& Z, VectorXd& xtx, VectorXd& estimates, 
				       double * ycorr, VectorXd& var, double * var_e, 
				       sampler& mcmc_sampler, mp_container& thread_vec, double lambda) {
