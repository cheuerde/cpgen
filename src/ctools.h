...
RcppExport SEXP cSSBR_impute(SEXP A11R, SEXP A12R, SEXP MR, SEXP index_gtR, SEXP index_ngtR, SEXP threadsR);
RcppExport SEXP csolve_sparse_fac_three(SEXP XR, SEXP yR, SEXP threadsR);
